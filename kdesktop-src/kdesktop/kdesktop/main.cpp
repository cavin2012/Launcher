...
void game_instance::app_load_settings_config(const config& cfg)
{
	...
	game_config::min_launcher_ver = version_info(cfg["min_launcher_verion"].str());
	VALIDATE(game_config::min_launcher_ver.is_rose_recommended(), null_str);
}
