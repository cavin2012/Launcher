...
void tethernetip::pre_show()
{
	...
	// ip addr
	ipaddr_.reset(new ttext_box2(*window_, *find_widget<tcontrol>(window_, "ipaddr", false, true), "textbox", null_str));
	ipaddr_->set_did_text_changed(boost::bind(&tethernetip::did_text_box_changed, this, _1, etype_ip));
	...
	// subnet mask
	subnet_mask_.reset(new ttext_box2(*window_, *find_widget<tcontrol>(window_, "subnet_mask", false, true), "textbox", null_str));
	subnet_mask_->set_did_text_changed(boost::bind(&tethernetip::did_text_box_changed, this, _1, etype_subnetmask));
	...
	// gateway
	gateway_.reset(new ttext_box2(*window_, *find_widget<tcontrol>(window_, "gateway", false, true), "textbox", null_str));
	gateway_->set_did_text_changed(boost::bind(&tethernetip::did_text_box_changed, this, _1, etype_gateway));
