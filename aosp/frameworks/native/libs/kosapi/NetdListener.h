...
public:
    ...
    void setNetStateChanged(fkosNetStateChanged did, void* user) {
        mNetStateChanged = did;
        mNetStateChangedUser = user;
    }
...
private:
    ...
    bool mWithSeq;
    fkosNetStateChanged mNetStateChanged;
    void* mNetStateChangedUser;
